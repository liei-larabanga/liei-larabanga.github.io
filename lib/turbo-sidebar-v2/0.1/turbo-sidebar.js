...
/**
 * Returns the content html element in the given tab of the sidebar.
 * 
 * @param {string} tabId
 */
TurboSidebar.prototype.getPaneContentContainer = function(paneId) {
  return $(this._sidebar).find('#'+ paneId +' .pane-content')[0] || undefined;
}
